...
public class StudentController {
	...
	public ModelAndView update(ModelAndView modelAndView, Student student) {
		
		int result = 0;
		
		result = studentService.save(student);//사용자에게 전달 받은 스튜던트 객체 전달 받
