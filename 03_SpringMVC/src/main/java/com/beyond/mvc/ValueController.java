...
public class ValueController {
	 ...
	 * 		- 스플링에서는 jackson라이브러리를 추가하고 @ResponseBody을 사용하면 컴트롤러 메소드에서 리턴되는 객체를 자동으로  json 문자열로 변경해서 응답한다.
	 * 
	 * @RestController
	 * 		- @Controllerr와 @ResponseBody를 합쳐놓은 역할을 수행한다.
